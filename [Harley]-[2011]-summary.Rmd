...
## Broad Questions
This paper is documenting a new predation pattern as a result of anthropogenic climate change, so this shifting set of conditions negatively affecting prey is “our fault”. Is it our responsibility to now exercise direct impact on the predator?
No, we do not know what impact this would have (ecosystems are really complex, we don’t want to do more harm accidentally)
Maybe? It is difficult to undo all the impacts of humans, and fixing them by creating more human impacts seems wrong
No, we do have a responsibility, but maybe this responsibility can be to monitor/understand impacts of the predator/be more aware
Responsibility does not necessarily mean removal.
We should be fixing the underlying mechanism, instead of removing sea stars as a bandaid fix. 
Invasive species management: it’s directly our fault most of the time when invasive species are introduced. How much do we mitigate their spread? What do we care about in conservation, and to what extent?
Ecosystems are going to change regardless, so should we change everything based on what we want to see?
What lens are you looking through when looking at the ecosystems and conservations? What do we think is worth preserving? (trait based approach)
Looking at species-based vs ecosystem-based conservation 
Should/can you separate science and management? (Should the people doing the science be involved with the management)? In relation to the paper.
Two parties, one that understands the problem, and one that understands management and problem mitigation
Management tends to have a bias related to economy so science and management should work together since the researchers could be less biased
Scientists always need to help inform decisions but they need help disseminating the information. Science doesn’t have value unless it can reach the public. Need a mix of different people to help making decisions (scientists might not be able to make the best decisions based on what the public wants).
Discussed bias in science
Does the public want conservation science to be unbiased?
Should science inform policy makers, or would that be science with an agenda, creating lots of bias?
Scientists need a lot of help making science accessible, and if the papers exist in a vacuum of academics it is essentially useless
Conservation is really based on ecosystem services since it has important economic implications. Emotional attachment also plays a role, so species-based conservation is effective for funding.
I wouldn’t trust scientists to create policies. We need people who can think about society and how it’s structured in order to help stop climate change to help solve the problem.
Science needs to be accessible so that management and the public can help to make the decision rather than just relying on a biased science.
The process of creating science, getting it to the public and creating policies on that science should be teamwork!! Many specialists of different kinds need to be working together to make change
Science might not necessarily be biased as long as you’re building strong hypotheses.
The role of the scientist is not to determine which of the possibilities, but what the possibilities are.

## Changing Viewpoints
This paper was criticized quite a bit for its narrative format during discussions. However, this format makes it more accessible to public and policy makers instead of being replicable science, so perhaps this format is a good thing?
